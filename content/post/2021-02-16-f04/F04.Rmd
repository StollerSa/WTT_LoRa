...
select(c("Time","Rssi","Payload.Content.Temperature","Payload.Content.BatteryVoltage","Payload.Content.GpsAverageSignal"))%>%
...
F04LocData <- mydata  %>%
  dplyr::filter(DeviceEUI == "3633333053397F04")%>% 
          ...
          dplyr::filter(Payload.Content.Time > "2021-02-03 00:00:02")
